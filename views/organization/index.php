...
<head>
    ...
    <title>CRUD API organization</title>
</head>
...
<body>
    ...
    $(document).ready(function() {
        ...
        $('#sample_form').on('submit', function(event) {
            ...
            if ($('#action').val() == "Add") {
                ...
                $.ajax({
                    url: "http://localhost/uas/api/organization/create.php",
                    method: "POST",
                ...
                $.ajax({
                    url: "http://localhost/uas/api/organization/update.php",
                    method: "PUT",
                    data: JSON.stringify(formData),
                    success: function(data) {
                        $('#action_button').attr('disabled', false);
    ...
    function showAll() {
        $.ajax({
            ...
            url: "http://localhost/uas/api/organization/read.php",
    ...
    function deleteOne(id) {
        ...
        $.ajax({
            url: "http://localhost/uas/api/organization/delete.php",
            method: "DELETE",
            data: JSON.stringify({
                "id": id
            }),
